import { JSXExpressionContainer, isCallExpression, CallExpression, isMemberExpression, MemberExpression, isIdentifier, Identifier, ArrowFunctionExpression,  } from "babel-types";
...
export class JSXExpressionMap implements ParserPredicate {
    ...
    parse(token: JSXExpressionContainer): any {
        ...
        return {
            ...
            baseItem: {
                type: 'Identifier',
                name: this.getBaseObjectName(callee)
            },
